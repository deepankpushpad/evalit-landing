...
const Footer = () => {
  return (
    <div className="flex bg-tertiary w-full justify-center items-center lg:justify-evenly lg:flex-row flex-wrap">
      <div className="lg:p-10 flex flex-col lg:mt-8 lg:w-1/4 w-1/2 justify-center items-center pt-10 p-4 lg:pt-0 lg:gap-4 gap-2  ">
      ...
      <div className="flex flex-col lg:p-10 lg:mt-8 mt-5 lg:w-1/4 w-1/2 justify-center items-center lg:pr-7 ">
      ...
      <div className="flex flex-col lg:p-10 lg:mt-8  lg:w-1/4 w-1/2 justify-center items-center pl-4 mt-4 mb-8 lg:mb-0">
        <ul className="text-gray-700 font-karma flex flex-col gap-2 font-bold lg:p-0 ">
      ...
      <div className="flex  lg:w-1/6   w-1/2     ">
        <div className="w-full flex lg:justify-evenly items-center justify-center lg:mr-0 mr-8 mb-3 lg:mb-0 ">
          ...
          <img
            ...
            alt="twitter"
            className=" aspect-auto lg:w-10 lg:h-10 w-12 h-12"
          />
        </div>
      </div>
    </div>
